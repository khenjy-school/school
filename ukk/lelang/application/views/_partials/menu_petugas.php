<!-- menu navigasi untuk pengguna dgn level tb_petugas -->
  ...
  <li class="nav-item">
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <h6 class="dropdown-header">Entri Lelang</h6>
        ...
        <!-- <a class="dropdown-item" href="<?= site_url('history_lelang') ?>"><?= $tabel2_alias ?></a> -->
      </div>
    </div>
  </li>
