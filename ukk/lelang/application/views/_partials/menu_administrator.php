  ...
  <li class="nav-item">
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item" href="<?= site_url('tb_barang') ?>"><?= $tabel6_alias ?></a>
        <a class="dropdown-item" href="<?= site_url('tb_lelang') ?>"><?= $tabel8_alias ?></a>

        <div class="dropdown-divider"></div>
        <h6 class="dropdown-header">Operasional Sekolah</h6>
        <a class="dropdown-item" href="<?= site_url('tb_masyarakat') ?>"><?= $tabel4_alias ?></a>
        <a class="dropdown-item" href="<?= site_url('tb_level') ?>"><?= $tabel5_alias ?></a>
        <a class="dropdown-item" href="<?= site_url('tb_petugas') ?>"><?= $tabel9_alias ?></a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    terimakasih pada link di atas -->
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="<?= site_url('tb_petugas/profil') ?>">Profil</a>
        <a class="dropdown-item" href="<?= site_url('tb_petugas/logout') ?>">Logout</a>
      </div>
    </div>
  </li>
</ul>