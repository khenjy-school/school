...
<form action="<?= site_url('history_lelang/filter_siswa') ?>" method="get">
  ...
  <div class="row">
    ...
    <div class="col-md-auto">
      <div class="row">
        ...
        <div class="col-auto">
          <div class="input-group">
            <a class="btn btn-danger text-light" type="button" href="<?= site_url('history_lelang/daftar') ?>">
    ...
    <tbody>
      <?php foreach ($tabel2 as $tl2) : ?>
        <?php foreach ($tabel6 as $tl6) : ?>
          <?php if ($tl6->id_barang === $tl2->id_barang) { ?>
            <tr>
