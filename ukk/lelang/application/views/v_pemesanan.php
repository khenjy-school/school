...
<form action="<?= site_url('tb_lelang/tambah') ?>" method="post">
  ...
  <div class="row justify-content-start mt-4">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label>tb_masyarakat</label>
        <input class="form-control" type="text" required name="tb_masyarakat" placeholder="Masukkan nama tb_masyarakat">
      </div>
      ...
      <div class="form-group">
        ...
        <select class="form-control" required name="id_barang">
          ...
          <?php foreach ($tabel6 as $tl6) : ?>
            <option value="<?= $tl6->id_barang; ?>"><?= $tl6->tipe ?></option>
          <?php endforeach ?>
        </select>
      </div>
      <!-- keterangan * -->
      <small>*Email dibutuhkan untuk melakukan tb_lelang dan transaksi</small>
