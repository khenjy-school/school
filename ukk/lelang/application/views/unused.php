          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                <php if ($this->session->userdata('level') == 'tb_masyarakat' && $this->session->userdata('level') <> 'tb_petugas' && $this->session->userdata('level') <> 'accounting') { ?>
                ...
                <php } elseif ($this->session->userdata('level') == 'tb_petugas') { ?>
