...
// Masih banyak fitur-fitur yang kurang pada fitur tb_lelang seperti fitur cancel tb_lelang.
// Dan juga seharusnya ketika user melakukan tb_lelang seharusnya stok tb_level tidak langsung berkurang
// // Melainkan harus menunggu tb_petugas membooking tb_level untuk customer terlebih dulu
// Saya baru berpikir untuk mengubah juga query sql pada trigger tambah tb_level
// Yaitu untuk menambah stok tb_level dan input ke history_lelang jika status pesannanya NOT IN (pending)
// Hal ini akan diperbaiki pada waktu-waktu mendatang. 

include 'Welcome.php';
session_write_close();
class Tb_lelang extends Welcome
{
	...
	// Jika user menggunakan tombol cari untuk mencari tb_lelang, namun pada views masih menggunakan v_pembayaran, 
	// maka fitur ini dibutuhkan untuk membedakan user mana yang sedang mencari daftar tb_lelang/history_lelang/transaksi 
	...
	public function cari($tabel7_field1 = 1)
	{
		...
		$data1 = array(
			...
			// mencari dan menampilkan id tb_lelang berdasarkan id_pembayaran yang telah diinput
