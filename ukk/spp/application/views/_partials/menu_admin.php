...
<ul class="navbar-nav ml-auto">
  ...
  <li class="nav-item">
    <a class="nav-link text-decoration-none font-weight-bold" href="<?= site_url('member') ?>">Member</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-decoration-none font-weight-bold" href="<?= site_url('outlet') ?>">Outlet</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-decoration-none font-weight-bold" href="<?= site_url('paket') ?>">Paket</a>
  </li>
  <li class="nav-item">
