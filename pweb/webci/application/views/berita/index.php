...
<article>        
  <div class="col-9" id="latar">
    ...
    <?php  
        ...
        {   echo  '<a href="'.base_url("berita/manage").'""><div class="button_utm" style="margin-right: 0px; margin-left: auto">Manage</div></a>';
        } 
    ?>
    <?php foreach ($depan as $item): ?>                
    <div class="ktk2 kiri">
        <div class="bingkai">
            <a href="<?php echo site_url('berita/'.$item['id'].'/'.url_title($item['title'],'dash', true).'/'); ?>">
            <div class="gambar" style="display:block;height:150px;width:150px; background:url(<?php echo base_url('file/images/berita/thumb/'.$item['image_path']);?>);background-size: 150px 150px;"></div>
            </a>
            <div class="ktk-kanan">
                <a href="<?php echo site_url('berita/'.$item['id'].'/'.url_title($item['title'],'dash', true).'/'); ?>">
