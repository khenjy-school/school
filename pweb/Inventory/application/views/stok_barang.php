<div class="main">
    <div class="sect1">
        <h4>Stok Barang</h4>
        <div class="button">
            <a href="<?= base_url().'index.php/Controller/print_stok'?>" class="print"><span class="fas fa-print"></span> Print</a>
            <a href="<?= base_url().'index.php/Controller/excel_stok'?>" class="excel"><span class="fas fa-file-excel"></span> Excel</a>
        </div>
    </div>
    <table>
        <tr>
